    ...
    <>
      ...
      {mobileOpen && (
        <>
          <button
            type="button"
            className="fixed inset-0 z-[1002] bg-black/40 backdrop-blur-sm lg:hidden"
            onClick={() => setMobileOpen(false)}
            aria-label="Close menu overlay"
          />

          <aside
            className="fixed right-0 top-0 z-[1003] h-full w-[300px] border-l border-slate-200 bg-white p-6 shadow-2xl lg:hidden"
