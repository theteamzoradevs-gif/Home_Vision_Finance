...
export const metadata = createPageMetadata(
  "About Us",
  "Learn about Vision Homes Finance — SBI Authorised Channel Partner helping families secure stress-free home loans.",
  "/about"
);
  ...
  return (
    <>
      <PageHero
        ...
        description="Vision Homes Finance is a certified premium financial consultancy specializing in retail mortgages. As an authorised channel partner of SBI, we help families lock down dream homes with expert coordination and ₹0 processing fee charges."
      />
