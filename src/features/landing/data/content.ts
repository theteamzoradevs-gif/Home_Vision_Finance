...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    content: [
      "State Bank of India continues to be one of the most preferred lenders for home loans in India. As an SBI Authorised Channel Partner, Vision Homes Finance helps borrowers access priority processing and competitive rates.",
  ...
  },
  {
    ...
    content: [
      ...
      "Vision Homes Finance compares offers across SBI, HDFC, PNB, and other leading banks to find the optimal transfer option — often with zero processing fees through our partner network.",
    ],
  },
  {
