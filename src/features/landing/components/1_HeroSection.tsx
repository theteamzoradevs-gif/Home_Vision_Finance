...
const HERO_USPS = [
  { text: "₹0 Processing Fees", subtitle: "Save Thousands" },
  { text: "Processing Support & Quick Eligibility", subtitle: "End-to-end documentation help" },
  { text: "Builder & Broker Coordination", subtitle: "We handle the running around" },
  { text: "Rates starting from 8.50%* p.a.", subtitle: "Best market rates compared" },
];
          ...
          <div className="mt-8 grid grid-cols-1 gap-3.5 sm:grid-cols-2">
            {HERO_USPS.map((item) => (
              ...
              >
                ...
                <div>
                  <h4 className="text-[13px] font-bold leading-tight text-navy">{item.text}</h4>
